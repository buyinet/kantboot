<template>
	<view>
		<view v-if="show1" style="background-color: #5EB2F3;width: 100%;height: 100vh;
		position: fixed;
		z-index:1000;
 ...
 -->
				...
				<u-col span="4.5">
					<view class="btn_images">
						...
						<image @click="pay()" v-show="!bodyData.buy" class="btn_image" src="../../static/index_3.png">
						</image>
						<image @click="toPlay(bodyData.id)" v-show="bodyData.buy" class="btn_image"
							src="../../static/index_03.png"></image>
						<view style="height: 20rpx;"></view>
						<image @click="collection()" class="btn_image" v-show="!bodyData.collection"
							src="../../static/index_2.png"></image>
						<image @click="cancelCollection()" v-show="bodyData.collection" class="btn_image"
							src="../../static/index_2_1.png"></image>
					</view>
				</u-col>
		...
		onLoad(option) {
			...
			Request.request({
				...
				success: (res) => {
					...
					this.ranfaWorkId = option.ranfaWorkId;
					this.$forceUpdate();
				}
			});
		},
