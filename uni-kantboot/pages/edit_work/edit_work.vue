			...
			findById(id) {
				Request.request({
					...
					success: (res) => {
						...
						this.coverFrontImage =
						this.paramData.fileUrlByFrontCoverImage;
						this.coverBackImage =
							this.paramData.fileUrlByBackCoverImage;
						var fileUrlsOfVideos=this.paramData.fileUrlsOfVideo;
						...
						this.brandBySelected =
							this.paramData.ranfaBrand;
