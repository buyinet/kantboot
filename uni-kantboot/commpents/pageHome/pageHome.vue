	...
	<view>
		...
		<view class="click-to">
			<view @click="toPage('/pages/buy_success_work/buy_success_work')">
				<image style="width: 45rpx;" mode="widthFix" src="../../static/home_icon1.png">
				</image>
				<text>已购买的教学视频</text>
			</view>
			<view @click="toPage('/pages/my_work/my_work')">
				<image style="width: 45rpx;" mode="widthFix" src="../../static/home_icon2.png">
				</image>
				<text>我的作品</text>
			</view>
			<view @click="toPage('/pages/upload_work/upload_work')">
				<image style="width: 45rpx;" mode="widthFix" src="../../static/home_icon3.png">
				</image>
				<text>上传作品</text>
			</view>
			<view @click="toPage('/pages/user_self_collection/user_self_collection')">
				<image style="width: 45rpx;" mode="widthFix" src="../../static/home_icon4.png">
				</image>
				<text>收藏</text>
			</view>
			<view @click="toPage('/pages/guanyuwomen/guanyuwomen')">
				<image style="width: 45rpx;" mode="widthFix" src="../../static/home_icon5.png">
				</image>
				<text>平台说明</text>
			</view>
		</view>
