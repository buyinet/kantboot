  ...
  <el-card>
    ...
    >
      ...
      <el-form
        ...
        <el-form-item label="Mch ID">
          <el-input v-model="paramData.mchId"/>
        </el-form-item>

        <el-form-item label="Mch Key">
          <el-input v-model="paramData.mchKey"/>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    toSave() {
      ...
      this.$request.post({
        url: this.$api.tpWechatAppletPayParam.save,
        data: this.paramData,
        stateSuccess: (res) => {
