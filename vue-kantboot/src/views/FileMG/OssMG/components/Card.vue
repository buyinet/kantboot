<template>
  <el-card>
    ...
    <el-table
      ...
      <el-table-column prop="bodyFolder" label="主目录"/>
      <el-table-column prop="endpoint" label="endpoint"/>
      <el-table-column prop="accessKeyId" label="access key ID"/>
      <el-table-column prop="accessKeySecret" label="access key secret" width="150"/>
      <el-table-column prop="bucketName" label="bucket name"/>
      <!-- <el-table-column prop="host" label="host"/> -->
      <!-- <el-table-column prop="callbackUrl" label="callback url"/> -->
...
export default {
  ...
  methods: {
    ...
    findCommonPage() {
      ...
      this.$request.post({
        url: this.$api.fileOss.findCommonPage,
        data: this.paramData,
        stateSuccess: (res) => {
