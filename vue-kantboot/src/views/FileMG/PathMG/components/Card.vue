<template>
  <el-card>
    ...
    <el-table
      ...
      <el-table-column prop="uploadUrl" label="上传的Url"/>
      <el-table-column prop="uploadUri" label="上传的Uri"/>
...
export default {
  ...
  methods: {
    ...
    findCommonPage() {
      ...
      this.$request.post({
        url: this.$api.filePath.findCommonPage,
        data: this.paramData,
        stateSuccess: (res) => {
