    ...
    <el-scrollbar style="height:calc( 100vh - 305px )">
      ...
      <el-form label-position="top" :model="paramData" label-width="120px">
        ...
        <el-form-item label="endpoint">
          <el-input v-model="paramData.endpoint" />
        </el-form-item>

        <el-form-item label="access key id">
          <el-input v-model="paramData.accessKeyId" />
        </el-form-item>

        <el-form-item label="access key secret">
          <el-input v-model="paramData.accessKeySecret" />
        </el-form-item>

        <el-form-item label="bucket name">
          <el-input v-model="paramData.bucketName" />
        </el-form-item>

        <el-form-item label="host">
          <el-input v-model="paramData.host" />
        </el-form-item>

        <el-form-item label="上传的url">
          <el-input v-model="paramData.uploadUrl" />
        </el-form-item>

        <el-form-item label="callback url">
          <el-input v-model="paramData.callbackUrl" />
        </el-form-item>
