...
//    private CesRanfaWork ranfaWork;

    /**
     * 染发视频的文件id
     */
    @Column(name="file_id_by_video")
    private String fileIdByVideo;
     ...
     * @return
     */
    public String getFileUrlByVideo(){
        return  getSetting().getFileVisitUrl()+fileIdByVideo;
    }
